...
2. ML classification-based voice recognition
3. Training a Small Audio Model via cosine similarity for Voice Recognition
4. Explored Google APIs and OAuth 2.0

## Reach Me:
Email: [rdnathkolkata@gmail.com](mailto:rdnathkolkata@gmail.com) <br>
...
<!--
**RDnathKolkata/RDnathKolkata** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
